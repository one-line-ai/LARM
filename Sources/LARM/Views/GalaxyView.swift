...
struct GalaxyView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> WKWebView {
        ...
        cfg.userContentController.addUserScript(WKUserScript(source: "window.LARM_DATA = \(json);", injectionTime: .atDocumentStart, forMainFrameOnly: true))
    ...
    func updateNSView(_ web: WKWebView, context: Context) {
        guard context.coordinator.lastJSON != json else { return }
        context.coordinator.lastJSON = json
